...
namespace RayTracing.Objects
{
    ...
    {
        Camera camera = new(new(2, 6, 8), new(0, 2.5f, 0), new(0, 1, 0), 50);
        ...
        public TextureScene()
        {
            ...
            var specularFull = new Material() { Specular = new(1f, 1f, 1f), SpecularDistance = 0.01f };
            ...
            Rectangle floor = new(new(-10, 0, -5), new(20f, 0f, 0f), new(0, 0, 20), new() { Diffuse = new(0.5f, 0.5f, 0.5f) });
